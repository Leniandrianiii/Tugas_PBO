...
public class ViewPraktikum extends JFrame {
    ...
    public ViewPraktikum(){
        ...
        add(lform);
        lform.setFont(new Font("Times New Roman", Font.BOLD, 20));
        lform.setBounds(5, 5, 700, 20);
        add(lHasil);
